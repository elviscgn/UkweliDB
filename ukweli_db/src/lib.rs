...
#![deny(clippy::panic)]
// since I don't ever want our db to ever crash, i'm going to ban usage of panics or anything
// that might cause our program to crash, putting it here for any future contributors
...
impl Record {
    fn new(index: usize, payload: &str, prev_hash: &str) -> Self {
        Self {
            index,
